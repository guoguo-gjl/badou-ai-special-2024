...
def InceptionV3(input_shape=[299, 299, 3],
    ...
    x = layers.concatenate(
        [branch3x3, branch3x3db1, branch_pool], axis=3, name = 'mixed3'
    )
    ...
    branch7x7x3 = conv2d_bn(branch7x7x3, 192, 3, 3, strides=(2, 2))(x)
    branch_pool = MaxPooling2D((3, 3), strides=(2, 2))(x)
...
def preprocess_input(x):
    x /= 255  # 将x归一化到区间[0,1]之间
    x -= 0.5  # 将x平移到[-0.5, 0.5]之间
    x *= 2.  # 将x放大到[-1, 1]之间
    return x
